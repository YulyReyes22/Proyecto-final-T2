...
def index():
    ...
    ax.bar(df['Fuente'], df['Producción (TWh)'], color=['#2E8B57', '#87CEEB', '#98FF98', '#A67B5B', '#B5C99A'])
    ...
    ax.pie(df_graph['Participación'], labels=df_graph['Energía Renovable'], autopct='%1.1f%%', 
    startangle=90)
    ...
    plt.plot(wind_data['Year'], wind_data['Wind Capacity'], label='Capacidad Eólica', color='#2E8B57', marker='o')
    plt.plot(solar_data['Year'], solar_data['Solar Capacity'], label='Cpacidad Solar', color='#87CEEB', marker='X')
